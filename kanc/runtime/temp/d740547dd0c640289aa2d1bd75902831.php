<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\AppServ\www\kanc\public/../application/admin\view\lunbo\update.html";i:1552240789;s:71:"C:\AppServ\www\kanc\public/../application/admin\view\public\layout.html";i:1552227586;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="panel-body">
       <form action="" method="POST">
            <div class="form-group">
                <label for="">图片</label>
                <!-- 修改页面的预览图 -->
                <div><img src="__STATIC__/uploads/<?php echo $data['img']; ?>" alt="" width="80px" height="60px"></div>
                <div id="queue"></div>
